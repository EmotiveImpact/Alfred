...
(() => {
  ...
  function draw(){
    ...
    const labels={model_needs_review:'The proposed answer did not pass the evidence checks and has been withheld. Inspect the source passages.',sources_found:'Supporting excerpts, not an AI-generated answer.',no_sources:'No supporting notes found. Nothing has been invented.',model_interpretation:'Model interpretation. Citations checked; factual entailment is not verified.',model_abstained:'The local model could not establish an answer from these excerpts.',model_unavailable_or_invalid:'The local model failed or returned invalid citations. No generated answer is shown.'};
